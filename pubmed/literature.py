...
class PubMed(object):
    ...
    def __init__(self, PMID=''):
        self.PMID = str(PMID)
        self.url = 'http://eutils.ncbi.nlm.nih.gov/entrez/eutils/esummary.fcgi?db=pubmed&id={ids}'.format(ids=self.PMID)
        ...
        PubMed_funs = filter(lambda x:not x.startswith('_'),PubMed.__dict__.keys())
